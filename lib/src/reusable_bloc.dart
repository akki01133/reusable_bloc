...
abstract class DataBloc<T> extends Bloc<DataEvent<T>, DataState<T>> {
  ...
  Future<void> _mapFetchDataToState(
    ...
    return _handleStatesOnEvent(
      isNoOp: state is DataFetching || state is DataError || state is DataSuccess,
  ...
  Future<Either<Failure,T>> fetchAndParseData<Failure>(DataState<T> oldState, FetchData event);
}
